    ...
    <nav class="mt-4 px-3">
        <ul class="space-y-2">
            @foreach ($menus as $menu)
                <li>
                    <a href="{{ $menu['url'] }}"
                        class="flex items-center px-4 py-3 text-gray-400 rounded-lg hover:bg-[#E00852] hover:text-white duration-200 {{ request()->routeIs($menu['route']) ? 'bg-red-400 text-white' : '' }}">
